package br.com.zupacademy.ratkovski.exception
...
internal class GlobalExceptionHandlerTest{
    ...
    @Test
    internal fun `deve retornar 4OO quando statusException for invalid argument`() {
    ...
    @Test
    internal fun `deve retornar 5OO quando quando qualquer outro erro for lancado`() {
